...
function setupFavicon() {
  const svgString = `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="256" y="270" font-family="Georgia, serif" font-size="150" font-weight="bold" fill="#A0633A" text-anchor="middle">SF</text>
    <text x="256" y="410" font-family="Georgia, serif" font-size="38" font-weight="300" fill="#FFFFFF" text-anchor="middle" letter-spacing="5">SERVICEFLOW</text>
  </svg>`;
